# 📊 Statistics for Beginners – Student Marks Dataset
...
= (78 + 85 + 78 + 92 + 67 + 85 + 74 + 90 + 78 + 60) / 10  
= 787 / 10  
= **78.7**
...
### 3️⃣ Mode (Majority Category – Gender)
...
👉 **Mode = No single mode (Both genders are equal)**

---

## 🎯 Summary

- **Mean (Average Marks)** = 78.7  
- **Median (Middle Marks)** = 78  
- **Mode (Gender Majority)** = No majority (Equal number of boys and girls)  
